...
\usepackage{luatexja-fontspec}          %for loading fonts
...
% \newcolumntype{R}{>{\hsize=90pt \raggedleft\arraybackslash}X}
% \newcolumntype{P}{p{280pt}}
...
\setsansjfont{Songti SC Bold}
\ltjsetparameter{
  kanjiskip={0.6pt plus 0.4pt minus 0.4pt},
  xkanjiskip={0.13\zw plus 1pt minus 1pt}}
% \def\ltj@stdmcfont{name:Songti SC}
% \def\ltj@stdgtfont{name:Songti SC}
