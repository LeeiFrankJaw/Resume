...
\begin{tabularx}{.935\textwidth}{r|X}
  \textsc{Sep 2018--}    & \href{https://www.fsf.org/blogs/sysadmin/introducing-lei-zhao-intern-with-the-fsf-tech-team}{Fall intern} at \href{https://www.fsf.org/}{Free Software Foundation} \\
  ...
  \textsc{Jan--Jun 2018} & \textsc{olap} and \textsc{etl} programmer at \href{https://www.haomaiyi.com/}{\textsc{Haomaiyi}}, Shanghai \\
                         ...
                         & \footnotesize I extracted data from different sources, transformed them into desired forms, and loaded them into data warehouse for later analytics.  I helped set up the \href{https://superset.incubator.apache.org/}{Superset} BI platform, did some \href{https://en.wikipedia.org/wiki/Online_analytical_processing}{\textsc{olap}}, and provided results to our clients through web \textsc{api}s.\\
  \multicolumn{2}{c}{} \\
