...
\begin{tabularcv}
  \textsc{Nov} 2009 & 2nd Prize in National Olympiad in Informatics in Provinces (NOIP)\\
                    & \textbf{China Computer Federation}\\
                    & \footnotesize NOIP is an annual competitive programming competition for secondary school students.  The contest consists of five hours of programming on an individual basis, solving problems of an algorithmic nature.
\end{tabularcv}
