...
\begin{tabularx}{.935\textwidth}{r|X}
  \textsc{Jan--Jun 2018} & \textsc{olap} and \textsc{etl} programmer at \href{https://www.haomaiyi.com/}{\textsc{Haomaiyi}}, Shanghai \\
                         ...
                         & \footnotesize I extracted data from different sources, transformed them into desired forms, and loaded them into data warehouse for later analytics.  I also did some \textsc{olap} and provided results to our client through web \textsc{api}.\\
  \multicolumn{2}{c}{} \\
